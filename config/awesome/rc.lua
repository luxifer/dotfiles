...
function scandir(directory, filter)
    ...
    print(filter)
    for filename in popen('ls -1 "'..directory..'"'):lines() do
...
gears.timer.start_new (360, function()
  beautiful.wallpaper = wp_path .. wp_files[wp_index]
  for s in screen do
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "F8", function() xrandr.xrandr() end,
        {description = "monitor management", group = "hotkeys"}),
    awful.key({ }, "Print", function () awful.spawn.with_shell("deepin-screenshot -f -s ~/Images/screenshots/$(date +%s).png") end,
        {description = "print screen", group = "print"}),
    awful.key({ "Shift" }, "Print", function () awful.spawn.with_shell("deepin-screenshot -s ~/Images/screenshots/$(date +%s).png") end,
        {description = "print region", group = "print"}),
...
--]]
    ...
    awful.key({ modkey }, "space", function() 
	    awful.screen.focused().spotlight.visible = not awful.screen.focused().spotlight.visible
    end,
