...
local mytextclock = wibox.widget.textclock(markup.font(theme.font, "%a %d %b %Y %H:%M "))
...
local cpuicon = wibox.widget.textbox(markup.fontfg(theme.font, blue, "CPU "))
...
local memicon = wibox.widget.textbox(markup.fontfg(theme.font, blue, "Mem "))
...
local net = lain.widget.net({
    settings = function()
	widget:set_markup(markup.font(theme.font, net_now.received .. markup(blue, " ↓↑ ") .. net_now.sent))
    end
})

local netwidget = wibox.container.margin(net.widget, dpi(2), dpi(7), dpi(4), dpi(4))
